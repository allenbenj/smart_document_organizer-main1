...
Initial Save: When a new context is created (or when the agent is explicitly instructed 
to start working on the documents for analysis, use the memory_manager tool to save these 
facts. Use appropriate metadata:

      
{
    "thoughts": ["Initializing memory for the Ben Allen case."],
    "tool_name": "memory_manager",
    "tool_args": {
        "command": "save",
        "text": "Core facts for the Ben Allen extortion case:\n- Extortion attempt of $150,000.\n- Ben Allen is innocent.\n- ADA and Detective are corrupt.\n- Concealed familial relationship between detective, witness, and accuser.\n- ADA presented false evidence.",
        "metadata": {
            "type": "core_facts",
            "case": "Ben Allen Extortion",
            "source": "Initial Case Briefing"
        }
    }
}
