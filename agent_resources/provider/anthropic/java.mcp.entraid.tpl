...
{{/mcpConfigs}}
    ...
    public static class MCPClient {
        ...
        public MCPClient() {
            TokenCredential clientSecretCredential = new DefaultAzureCredentialBuilder().build();
            TokenRequestContext tokenRequestContext = new TokenRequestContext().addScopes("https://cognitiveservices.azure.com/.default");
            this.anthropicClient = AnthropicOkHttpClient.builder()
                .authToken(clientSecretCredential.getToken(tokenRequestContext).block().getToken())
                {{#endpoint}}
                .baseUrl("{{{endpoint}}}")
                {{/endpoint}}
                .build();
