...
### Recommend Models
- GitHub models support free trial, which is good for getting started, single agent, and simple chat app.
- Foundry models have better production support, more capabilities, larger context size, which is good for production use, multi-agent, and complex scenarios.
- (optional) Browse Models in AI Toolkit Model Catalog
