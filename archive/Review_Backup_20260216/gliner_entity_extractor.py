...
class GLiNERModel:
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        self.legal_entity_types = [
            ...
            "case_citation", "statute", "regulation", "court",
            "judge", "lawyer", "plaintiff", "defendant",
            "contract", "evidence", "crime", "penalty"
        ]
    ...
    def extract_entities(self, text: str, entity_types: Optional[List[str]] = None) -> NERResult:
    ...
    def _fallback_extraction(self, text: str, entity_types: Optional[List[str]] = None) -> NERResult:
...
class LegalNERAgent(BaseAgent):
    ...
    async def _process_task(self, task_data: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None) -> AgentResult:
        ...
        try:
            ...
            result = await self.process_document_async(text, extract_relationships, entity_types)
    ...
    async def process_document_async(self, text: str, extract_relationships: bool = False, 
    ...
    async def _store_entities_in_memory(self, entities: List[Dict[str, Any]], context: str):
...
class LegalNERPipeline:
    ...
    def process_document(self, text: str, extract_relationships: bool = False) -> Dict[str, Any]:
        ...
        if extract_relationships:
            relationships = self._extract_entity_relationships(ner_result.entities, text)
