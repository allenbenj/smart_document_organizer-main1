...
class ConfigurationManagerImpl(ConfigurationManager):
    ...
    def set(self, key: str, value: Any, source: ConfigurationSource = ConfigurationSource.DEFAULT) -> None:
    ...
    def get_sources(self, key: str) -> List[ConfigurationSource]:
    ...
    def _create_file_provider(self, path: Path) -> ConfigurationProvider:
        ...
        from ..interfaces.configuration import ConfigurationFormat
    ...
    def _notify_all_changes(self, old_config: Dict[str, Any], new_config: Dict[str, Any]) -> None:
