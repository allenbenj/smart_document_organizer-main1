...
from ..interfaces.configuration import ConfigurationManager  # noqa: E402
from ..interfaces.logging import LogCategory, LogLevel, StructuredLogger  # noqa: E402
from .formatters import CompactLogFormatter, HumanReadableLogFormatter, JsonLogFormatter  # noqa: E402
...
from .logger import StructuredLoggerImpl  # noqa: E402
...
class LoggerFactory:
    ...
    def create_console_logger(
        self, name: str, level: Optional[LogLevel] = None, use_colors: bool = True
    ) -> StructuredLogger:
    ...
    def create_memory_logger(
        self, name: str, max_records: int = 1000, level: Optional[LogLevel] = None
    ) -> StructuredLogger:
    ...
    def _create_logger(self, name: str, category: LogCategory) -> StructuredLogger:  # noqa: C901
...
def configure_logging(
    config_manager: ConfigurationManager, logs_dir: Optional[Path] = None
) -> None:
