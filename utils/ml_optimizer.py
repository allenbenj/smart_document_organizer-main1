...
from smart_document_organizer.utils.config_models import MLOptimizerConfig  # noqa: E402
from smart_document_organizer.utils.constants import Constants  # noqa: E402
...
# Initialize loggers
ml_logger = get_detailed_logger("MLOptimizer", LogCategory.ML)
performance_logger = get_detailed_logger("Performance", LogCategory.PERFORMANCE)
optimization_logger = get_detailed_logger("Optimization", LogCategory.OPTIMIZATION)
...
class MLOptimizer:
        ...
        try:
            with self._lock:
                ...
                record = {
                    ...
                    "metrics": asdict(metrics),  # noqa: F821
                    "features": asdict(features),  # noqa: F821
                ...
                with sqlite3.connect(self.db_path) as conn:
                    ...
                    """,
                        (
                            ...
                            json.dumps(asdict(metrics)),  # noqa: F821
                            json.dumps(asdict(features)),  # noqa: F821
                            objective.value,
                            composite_score,
                        ),
                    )
    ...
    def _optimize_parameters(  # noqa: C901
        self,
    ...
    def train_threshold_model(self, min_samples: int = 50) -> Optional[ThresholdModel]:
        ...
        try:
            ...
            ml_logger.info("Threshold model trained", parameters=asdict(thresholds))  # noqa: F821
            return thresholds
